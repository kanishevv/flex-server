...
export const PROJECT_PUBLIC_URL = `http://${SERVER_HOSTNAME}:${SERVER_PORT}/public`;
...
export const TRANSPORTER_SERVICE = process.env.TRANSPORTER_SERVICE;

export const TRANSPORTER_EMAIL = process.env.TRANSPORTER_EMAIL;

export const TRANSPORTER_PASSWORD = process.env.TRANSPORTER_PASSWORD;
